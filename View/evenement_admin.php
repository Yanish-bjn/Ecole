...
<!--link rel="stylesheet" type="text/css" href="../tableau/css/style3.css"-->
    ...
    <!-- Liens conteant le style de page-->
...
<div class="container">
  ...
  <p>
                  ...
                  foreach ($donnees as $value) { ?>
                    <tr class="">
                          <td class=""><?php echo $value['nom_evenement']?></td>
                          <td class=""><?php echo $value['nom_personne']?></td>
                          <td class=""><?php echo $value['date']?></td>
                          <td class=""><?php echo $value['description']?></td>
                          <td class=""><a class="btn btn-warning" href="modifier_evenement.php?id=<?php echo $value['id']; ?>">Modifier</a></td>
                          <td class=""><a class="btn btn-warning" data-toggle="modal" data-target="#exampleModal<?php echo $value['id'] ?>" href="../manager/supprimer_evenement.php?id=<?php $a = $value['id']; ?>">Supprimer</a>
...
<!--================ Fin du footer =================-->
  ...
  <!-- Début de la gestion d'erreur permetant d'affciherun message -->
 ...
 // Fonction permettant d'exporter les données au format pdf //
  function compte()
    {
