...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../connexion/vendor/daterangepicker/daterangepicker.css">	<link rel="stylesheet" type="text/css" href="../connexion/css/util.css">
	<link rel="stylesheet" type="text/css" href="../connexion/css/main.css">
	<link rel="stylesheet" type="text/css" href="../connexion/css/style.css"></head>
<body>
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="POST" action="../Manager/mot_de_passe1.php">
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						...
						<input class="input100" type="email" name="email" placeholder="Entre l'email" required>
